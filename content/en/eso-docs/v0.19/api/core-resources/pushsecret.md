+++
title = "PushSecret"
linkTitle = "PushSecret"
weight = 180
+++

![PushSecret](/diagrams-pushsecret-basic.png)
...
See [advanced templating](../../guides/external-secrets/advanced-templating/templating.md) for details.
