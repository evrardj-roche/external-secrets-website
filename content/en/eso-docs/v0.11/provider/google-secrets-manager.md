...
{{< readfile file=../snippets/gcpsm-wi-secret-store.yaml code="true" lang="yaml" >}}
...
{{< readfile file=../snippets/gcpsm-pod-wi-secret-store.yaml code="true" lang="yaml" >}}
...
{{< readfile file=../snippets/gcpsm-credentials-secret.yaml code="true" lang="yaml" >}}


#### Update secret store
Be sure the `gcpsm` provider is listed in the `Kind=SecretStore`

{{< readfile file=../snippets/gcpsm-secret-store.yaml code="true" lang="yaml" >}}
...
{{< readfile file=../snippets/gcpsm-external-secret.yaml code="true" lang="yaml" >}}
