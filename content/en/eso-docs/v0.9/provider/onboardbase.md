...
![Onboardbase External Secrets Provider](/onboardbase-provider.png)
...
![Onboardabse API Key](/onboardbase-api-key.png)
...
![Onboardabse API Key](/onboardbase-create-api-key.png)
