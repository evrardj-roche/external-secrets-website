...
{{< readfile file=../snippets/conjur-ca-bundle.yaml code="true" lang="yaml" >}}
...
{{< readfile file=../snippets/conjur-secret-store-apikey.yaml code="true" lang="yaml" >}}
...
> [!WARNING]
>
> Unless you are using a [ClusterSecretStore](../api/core-resources/clustersecretstore.md), credentials must reside in the same namespace as the SecretStore.
```shell
...
{{< readfile file=../snippets/conjur-secret-store-jwt-service-account-ref.yaml code="true" lang="yaml" >}}
...
{{< readfile file=../snippets/conjur-secret-store-jwt-secret-ref.yaml code="true" lang="yaml" >}}
...
{{< readfile file=../snippets/conjur-external-secret.yaml code="true" lang="yaml" >}}
...
{{< readfile file=../snippets/conjur-external-secret-find.yaml code="true" lang="yaml" >}}
