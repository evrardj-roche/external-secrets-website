...
![HCP Vault](/diagrams-provider-vault.png)
...
[Vault Generator](../api/core-resources/generators/vault.md).
...
{{< readfile file=../snippets/vault-token-store.yaml code="true" lang="yaml" >}}
...
{{< readfile file=../snippets/vault-approle-store.yaml code="true" lang="yaml" >}}
...
{{< readfile file=../snippets/vault-kubernetes-store.yaml code="true" lang="yaml" >}}
...
{{< readfile file=../snippets/vault-ldap-store.yaml code="true" lang="yaml" >}}
**NOTE:** In case of a `ClusterSecretStore`, Be sure to provide `namespace` in `secretRef` with the namespace where the secret resides.
...
{{< readfile file=../snippets/vault-userpass-store.yaml code="true" lang="yaml" >}}
**NOTE:** In case of a `ClusterSecretStore`, Be sure to provide `namespace` in `secretRef` with the namespace where the secret resides.
...
{{< readfile file=../snippets/vault-jwt-store.yaml code="true" lang="yaml" >}}
**NOTE:** In case of a `ClusterSecretStore`, Be sure to provide `namespace` in `secretRef` with the namespace where the secret resides.
...
{{< readfile file=../snippets/vault-mtls-store.yaml code="true" lang="yaml" >}}

### Access Key ID & Secret Access Key
You can store Access Key ID & Secret Access Key in a `Kind=Secret` and reference it from a SecretStore.

{{< readfile file=../snippets/vault-iam-store-static-creds.yaml code="true" lang="yaml" >}}
...
{{< readfile file=../snippets/vault-iam-store-sa.yaml code="true" lang="yaml" >}}

Reference the service account from above in the Secret Store:

{{< readfile file=../snippets/vault-iam-store.yaml code="true" lang="yaml" >}}
...
{{< readfile file=../snippets/vault-iam-store-controller-pod-identity.yaml code="true" lang="yaml" >}}
...
{{< readfile file=../snippets/vault-pushsecret.yaml code="true" lang="yaml" >}}
