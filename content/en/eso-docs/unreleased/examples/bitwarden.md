...
{{< readfile file=/snippets/bitwarden-cli-secrets.yaml code="true" lang="yaml" >}}

## Deploy Bitwarden CLI container

{{< readfile file=/snippets/bitwarden-cli-deployment.yaml code="true" lang="yaml" >}}
...
{{< readfile file=/snippets/bitwarden-secret-store.yaml code="true" lang="yaml" >}}
...
{{< readfile file=/snippets/bitwarden-secret.yaml code="true" lang="yaml" >}}
