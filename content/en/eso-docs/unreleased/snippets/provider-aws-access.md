+++
title = "Provider Aws Access"
linkTitle = "Provider Aws Access"
weight = 1480
+++
...
![Pod Identity Authentication](/diagrams-provider-aws-auth-pod-identity.png)
...
![SecretRef](/diagrams-provider-aws-auth-secret-ref.png)
...
![Service Account](/diagrams-provider-aws-auth-service-account.png)
