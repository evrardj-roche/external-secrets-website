...
linkTitle = "AWS Elastic Container Registry"
weight = 140
+++
...
{{< readfile file=/snippets/generator-ecr.yaml code="true" lang="yaml" >}}

Example `ExternalSecret` that references the ECR generator:
{{< readfile file=/snippets/generator-ecr-example.yaml code="true" lang="yaml" >}}
