+++
title = "AWS STS Session Token"
linkTitle = "AWS STS Session Token"
weight = 150
+++
...
{{< readfile file=/snippets/generator-sts.yaml code="true" lang="yaml" >}}

Example `ExternalSecret` that references the STS Session Token generator:
{{< readfile file=/snippets/generator-sts-example.yaml code="true" lang="yaml" >}}
