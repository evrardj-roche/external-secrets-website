...
{{< readfile file=/snippets/generator-password.yaml code="true" lang="yaml" >}}

Example `ExternalSecret` that references the Password generator:
{{< readfile file=/snippets/generator-password-example.yaml code="true" lang="yaml" >}}
...
{{< readfile file=/snippets/generator-password-encoding-examples.yaml code="true" lang="yaml" >}}
