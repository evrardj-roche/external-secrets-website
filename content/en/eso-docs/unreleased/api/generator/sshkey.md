...
{{< readfile file=/snippets/generator-sshkey.yaml code="true" lang="yaml" >}}

RSA SSH key with custom size:

{{< readfile file=/snippets/generator-sshkey-rsa.yaml code="true" lang="yaml" >}}

ECDSA SSH key:

{{< readfile file=/snippets/generator-sshkey-ecdsa.yaml code="true" lang="yaml" >}}

Example `ExternalSecret` that references the SSHKey generator:

{{< readfile file=/snippets/generator-sshkey-example.yaml code="true" lang="yaml" >}}
