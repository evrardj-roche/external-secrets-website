...
{{< readfile file=/snippets/generator-acr.yaml code="true" lang="yaml" >}}

Example `ExternalSecret` that references the ACR generator:

{{< readfile file=/snippets/generator-acr-example.yaml code="true" lang="yaml" >}}
...
{{< readfile file=/snippets/generator-acr-argocd-helm-repo.yaml code="true" lang="yaml" >}}
