+++
title = "Find Secrets by Name or Metadata"
linkTitle = "Find Secrets by Name or Metadata"
weight = 70
+++
...
{{< readfile file=/snippets/getallsecrets-find-by-name.yaml code="true" lang="yaml" >}}
...
To fetch multiple secrets matching a name pattern from a common SecretStore you can apply the following manifest:
{{< readfile file=/snippets/getallsecrets-find-by-tags.yaml code="true" lang="yaml" >}}
