+++
title = "Targeting Custom Resources"
linkTitle = "Targeting Custom Resources"
weight = 140
+++
...
{{< readfile file=/snippets/manifest-basic-configmap.yaml code="true" lang="yaml" >}}
...
{{< readfile file=/snippets/manifest-argocd-app.yaml code="true" lang="yaml" >}}
...
{{< readfile file=/snippets/manifest-templated-configmap.yaml code="true" lang="yaml" >}}
...
{{< readfile file=/snippets/manifest-advanced-path.yaml code="true" lang="yaml" >}}
...
{{< readfile file=/snippets/manifest-labeled-configmap.yaml code="true" lang="yaml" >}}
