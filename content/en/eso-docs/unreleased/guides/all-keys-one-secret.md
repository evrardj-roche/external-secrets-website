...
linkTitle = "Extract structured data"
weight = 60
+++
...
![secret-value](/img/screenshot_json_string_gcp_secret_value.png)
...
{{< readfile file=/snippets/gcpsm-data-from-external-secret.yaml code="true" lang="yaml" >}}
