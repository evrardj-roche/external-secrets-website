...
{{< readfile file=../../../snippets/helm-template-v2-escape-sequence.yaml code="true" lang="yaml" >}}

## Examples

You can use templates to inject your secrets into a configuration file that you mount into your pod:

{{< readfile file=../../../snippets/multiline-template-v2-external-secret.yaml code="true" lang="yaml" >}}

Another example with two keys in the same secret:

{{< readfile file=../../../snippets/multikey-template-v2-external-secret.yaml code="true" lang="yaml" >}}
...
{{< readfile file=../../../snippets/merge-template-v2-external-secret.yaml code="true" lang="yaml" >}}
...
{{< readfile file=../../../snippets/template-v2-from-secret.yaml code="true" lang="yaml" >}}
...
{{< readfile file=../../../snippets/template-v2-scope-and-target.yaml code="true" lang="yaml" >}}
...
{{< readfile file=../../../snippets/template-v2-literal-example.yaml code="true" lang="yaml" >}}
...
{{< readfile file=../../../snippets/pkcs12-template-v2-external-secret.yaml code="true" lang="yaml" >}}
...
{{< readfile file=../../../snippets/jwk-template-v2-external-secret.yaml code="true" lang="yaml" >}}
...
{{< readfile file=../../../snippets/filterpem-template-v2-external-secret.yaml code="true" lang="yaml" >}}
...
{{< readfile file=../../../snippets/filtercertchain-template-v2-external-secret.yaml code="true" lang="yaml" >}}
...
{{< readfile file=../../../snippets/rsadecrypt-template-v2-external-secret.yaml code="true" lang="yaml" >}}
...
{{< readfile file=../../../snippets/template-v2-push-secret.yaml code="true" lang="yaml" >}}
...
In addition to that you can use over 200+ [sprig functions](http://masterminds.github.io/sprig/). If you feel a function is missing or might be valuable feel free to open an issue and submit a [pull request](../../../community/contributing/process.md#submitting-a-pull-request).
