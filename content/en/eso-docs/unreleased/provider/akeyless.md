...
{{< readfile file=/snippets/akeyless-secret-store-k8s-auth.yaml code="true" lang="yaml" >}}
...
{{< readfile file=/snippets/akeyless-secret-store.yaml code="true" lang="yaml" >}}
...
{{< readfile file=/snippets/akeyless-external-secret.yaml code="true" lang="yaml" >}}
...
{{< readfile file=/snippets/akeyless-external-secret-json.yaml code="true" lang="yaml" >}}
...
{{< readfile file=/snippets/akeyless-push-secret.yaml code="true" lang="yaml" >}}
