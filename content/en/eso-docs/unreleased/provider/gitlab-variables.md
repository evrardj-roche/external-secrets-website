+++
title = "GitLab Variables"
linkTitle = "GitLab Variables"
weight = 220
+++
...
![token-details](/img/screenshot_gitlab_token.png)
...
![token-created](/img/screenshot_gitlab_token_created.png)
...
{{< readfile file=/snippets/gitlab-credentials-secret.yaml code="true" lang="yaml" >}}
...
{{< readfile file=/snippets/gitlab-secret-store.yaml code="true" lang="yaml" >}}
...
![projectID](/img/screenshot_gitlab_projectID.png)

### Creating external secret

To sync a GitLab variable to a secret on the Kubernetes cluster, a `Kind=ExternalSecret` is needed.

{{< readfile file=/snippets/gitlab-external-secret.yaml code="true" lang="yaml" >}}

#### Using DataFrom

DataFrom can be used to get a variable as a JSON string and attempt to parse it.

{{< readfile file=/snippets/gitlab-external-secret-json.yaml code="true" lang="yaml" >}}
