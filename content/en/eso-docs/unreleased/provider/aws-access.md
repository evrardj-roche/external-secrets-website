...
![Pod Identity Authentication](/img/diagrams-provider-aws-auth-pod-identity.png)
...
![SecretRef](/img/diagrams-provider-aws-auth-secret-ref.png)
...
![Service Account](/img/diagrams-provider-aws-auth-service-account.png)
