...
{{< readfile file=/snippets/beyondtrust-external-secret.yaml code="true" lang="yaml" >}}
...
{{< readfile file=/snippets/beyondtrust-secret.yaml code="true" lang="yaml" >}}
...
{{< readfile file=/snippets/beyondtrust-cluster-secret-store.yaml code="true" lang="yaml" >}}
...
{{< readfile file=/snippets/beyondtrust-push-secret.yaml code="true" lang="yaml" >}}
