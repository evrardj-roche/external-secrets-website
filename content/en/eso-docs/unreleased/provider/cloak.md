+++
title = "Cloak End 2 End Encrypted Secrets"
linkTitle = "Cloak End 2 End Encrypted Secrets"
weight = 320
+++

![Cloak End 2 End Encrypted Secrets](/img/cloak-provider-header.png)
...
{{< readfile file=/snippets/cloak-proxy-deployment.yaml code="true" lang="yaml" >}}

And a Kubernetes Service so External Secrets Operator can access the proxy.

{{< readfile file=/snippets/cloak-proxy-service.yaml code="true" lang="yaml" >}}

## Create a secret store

You can now place the configuration in any Kubernetes Namespace.

{{< readfile file=/snippets/cloak-secret-store.yaml code="true" lang="yaml" >}}
...
{{< readfile file=/snippets/cloak-external-secret.yaml code="true" lang="yaml" >}}
