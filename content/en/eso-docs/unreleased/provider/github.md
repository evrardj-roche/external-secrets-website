...
linkTitle = "Github Actions Secrets"
weight = 230
+++
...
{{< readfile file=/snippets/github-secret-store.yaml code="true" lang="yaml" >}}
...
{{< readfile file=/snippets/github-push-secret.yaml code="true" lang="yaml" >}}
