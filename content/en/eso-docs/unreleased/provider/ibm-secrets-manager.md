...
![iam](/img/screenshot_api_keys_iam.png)

On the left, click "API Keys", then click on "Create"

![iam-left](/img/screenshot_api_keys_iam_left.png)

Pick a name and description for your key:

![iam-create-key](/img/screenshot_api_keys_create.png)
...
![iam-create-success](/img/screenshot_api_keys_create_successful.png)
...
![iam-left](/img/screenshot_container_auth_create_group.png)

Pick a name and description for your group:

![iam-left](/img/screenshot_container_auth_create_group_1.png)

Click on "Access", and then on "Assign":

![iam-left](/img/screenshot_container_auth_create_group_2.png)

Click on "Assign Access", select "IAM services", and pick "Secrets Manager" from the pick-list:

![iam-left](/img/screenshot_container_auth_create_group_3.png)

Scope to "All resources" or "Resources based on selected attributes":

![iam-left](/img/screenshot_container_auth_create_group_4.png)

Select the "SecretsReader" service access policy:

![iam-left](/img/screenshot_container_auth_create_group_5.png)

Click "Add" and "Assign" to save the access group.

Next, on the left, click "Trusted profiles":

![iam-left](/img/screenshot_container_auth_iam_left.png)

Press "Create" and pick a name and description for your profile:

![iam-create-key](/img/screenshot_container_auth_create_1.png)
...
{{< readfile file=/snippets/ibm-container-auth-volume.yaml code="true" lang="yaml" >}}

### Update secret store
Be sure the `ibm` provider is listed in the `Kind=SecretStore`

{{< readfile file=/snippets/ibm-secret-store.yaml code="true" lang="yaml" >}}
...
![iam-create-success](/img/screenshot_service_url.png)
...
{{< readfile file=/snippets/ibm-es-types.yaml code="true" lang="yaml" >}}
...
{{< readfile file=/snippets/ibm-external-secret.yaml code="true" lang="yaml" >}}

Alternatively, the secret name along with its secret group name can be specified instead of secret ID to fetch the secret.

{{< readfile file=/snippets/ibm-external-secret-by-name.yaml code="true" lang="yaml" >}}
...
{{< readfile file=/snippets/ibm-external-secret-with-metadata.yaml code="true" lang="yaml" >}}
