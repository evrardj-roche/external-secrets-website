...
![aws sm](/img/eso-az-kv-aws-sm.png)
...
{{< readfile file=/snippets/aws-sm-store-secretsmanager-config.yaml code="true" lang="yaml" >}}
...
{{< readfile file=/snippets/aws-sm-push-secret-with-metadata.yaml code="true" lang="yaml" >}}
