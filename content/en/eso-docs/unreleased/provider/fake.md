...
{{< readfile file=/snippets/fake-provider-store.yaml code="true" lang="yaml" >}}
...
{{< readfile file=/snippets/fake-provider-es.yaml code="true" lang="yaml" >}}

This results in the following secret:


{{< readfile file=/snippets/fake-provider-secret.yaml code="true" lang="yaml" >}}
