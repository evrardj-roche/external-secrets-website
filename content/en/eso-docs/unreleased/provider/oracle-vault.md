...
{{< readfile file=/snippets/oracle-principal-type.yaml code="true" lang="yaml" >}}
...
![fingerprint-details](/img/screenshot_fingerprint.png)
...
![API-key-details](/img/screenshot_API_key.png)

Next, create a secret containing your private key and fingerprint:

{{< readfile file=/snippets/oracle-credentials-secret.yaml code="true" lang="yaml" >}}

After creating the credentials secret, the secret store can be configured:

{{< readfile file=/snippets/oracle-secret-store.yaml code="true" lang="yaml" >}}
...
{{< readfile file=/snippets/oracle-instance-principal.yaml code="true" lang="yaml" >}}
...
{{< readfile file=/snippets/oracle-workload-identity.yaml code="true" lang="yaml" >}}
...
{{< readfile file=/snippets/oracle-external-secret.yaml code="true" lang="yaml" >}}
#### External Secret targeting plaintext data

{{< readfile file=/snippets/oracle-external-secret-plaintext.yaml code="true" lang="yaml" >}}
...
{{< readfile file=/snippets/oracle-secret-store-pushsecret.yaml code="true" lang="yaml" >}}
