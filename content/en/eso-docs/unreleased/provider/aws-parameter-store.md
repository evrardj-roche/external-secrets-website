...
linkTitle = "AWS Parameter Store"
weight = 60
+++


![aws sm](/img/diagrams-provider-aws-ssm-parameter-store.png)
...
{{< readfile file=/snippets/aws-pm-push-secret-with-metadata.yaml code="true" lang="yaml" >}}
