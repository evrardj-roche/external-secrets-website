...
linkTitle = "Google Cloud Secret Manager"
weight = 150
+++
...
{{< readfile file=/snippets/gcpsm-wif-iam-secret-store.yaml code="true" lang="yaml" >}}
...
{{< readfile file=/snippets/gcpsm-wif-externalsecret.yaml code="true" lang="yaml" >}}
...
{{< readfile file=/snippets/gcpsm-wif-non-native-iam-secret-store.yaml code="true" lang="yaml" >}}
...
{{< readfile file=/snippets/gcpsm-wif-sa-secret-store.yaml code="true" lang="yaml" >}}
...
{{< readfile file=/snippets/gcpsm-wif-core-controller-secret-store.yaml code="true" lang="yaml" >}}
...
{{< readfile file=/snippets/gcpsm-wif-sa-secret-store-with-explicit-name-and-location.yaml code="true" lang="yaml" >}}
...
{{< readfile file=/snippets/gcpsm-sa-credentials-secret.yaml code="true" lang="yaml" >}}

Finally, reference this secret in the `SecretStore` manifest:

{{< readfile file=/snippets/gcpsm-sa-secret-store.yaml code="true" lang="yaml" >}}
