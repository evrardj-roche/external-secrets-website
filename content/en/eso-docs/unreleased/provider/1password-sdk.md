...
{{< readfile file=/snippets/1passwordsdk-secret-store.yaml code="true" lang="yaml" >}}
...
{{< readfile file=/snippets/1passwordsdk-external-secret.yaml code="true" lang="yaml" >}}
...
{{< readfile file=/snippets/1passwordsdk-push-secret.yaml code="true" lang="yaml" >}}
