...
{{< readfile file=/snippets/dvls-secret-store.yaml code="true" lang="yaml" >}}
...
{{< readfile file=/snippets/dvls-external-secret.yaml code="true" lang="yaml" >}}
...
{{< readfile file=/snippets/dvls-push-secret.yaml code="true" lang="yaml" >}}
