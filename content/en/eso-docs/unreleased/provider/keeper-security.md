...
{{< readfile file=/snippets/keepersecurity-secret-store.yaml code="true" lang="yaml" >}}
...
{{< readfile file=/snippets/keepersecurity-external-secret.yaml code="true" lang="yaml" >}}
...
{{< readfile file=/snippets/keepersecurity-push-secret.yaml code="true" lang="yaml" >}}
