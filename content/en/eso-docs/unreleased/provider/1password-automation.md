...
linkTitle = "1Password Connect Server"
weight = 250
+++
...
{{< readfile file=/snippets/1password-token-secret.yaml code="true" lang="yaml" >}}
1. Reference the secret in a SecretStore or ClusterSecretStore
{{< readfile file=/snippets/1password-secret-store.yaml code="true" lang="yaml" >}}
1. Create a Kubernetes secret with the Connect Server credentials
{{< readfile file=/snippets/1password-connect-server-secret.yaml code="true" lang="yaml" >}}
1. Reference the secret in a Connect Server Deployment
{{< readfile file=/snippets/1password-connect-server-deployment.yaml code="true" lang="yaml" >}}
...
![create-password-screenshot](/img/screenshot_1password_create_password.png)
...
![create-document-screenshot](/img/screenshot_1password_create_document.png)
...
![password-field-example](/img/screenshot_1password_password_field.png)
...
{{< readfile file=/snippets/1password-secret-store.yaml code="true" lang="yaml" >}}
{{< readfile file=/snippets/1password-external-secret-my-env-config.yaml code="true" lang="yaml" >}}
{{< readfile file=/snippets/1password-external-secret-my-cert.yaml code="true" lang="yaml" >}}
...
{{< readfile file=/snippets/1password-push-secret.yaml code="true" lang="yaml" >}}
