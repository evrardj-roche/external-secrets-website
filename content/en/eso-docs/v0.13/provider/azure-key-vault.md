...
{{< readfile file=../snippets/azkv-secret-store-mi.yaml code="true" lang="yaml" >}}
...
{{< readfile file=../snippets/azkv-workload-identity.yaml code="true" lang="yaml" >}}
...
{{< readfile file=../snippets/azkv-workload-identity-secretref.yaml code="true" lang="yaml" >}}
...
{{< readfile file=../snippets/azkv-secret-store.yaml code="true" lang="yaml" >}}
...
| `key`         | A JWK which contains the public key. Azure Key Vault does **not** export the private key. You may want to use [template functions](../guides/external-secrets/advanced-templating/templating.md) to transform this JWK into PEM encoded PKIX ASN.1 DER format. |
| `certificate` | The raw CER contents of the x509 certificate. You may want to use [template functions](../guides/external-secrets/advanced-templating/templating.md) to transform this into your desired encoding                                                             |
...
{{< readfile file=../snippets/azkv-external-secret.yaml code="true" lang="yaml" >}}
...
{{< readfile file=../snippets/azkv-datafrom-external-secret.yaml code="true" lang="yaml" >}}

To get a PKCS#12 certificate from Azure Key Vault and inject it as a `Kind=Secret` of type `kubernetes.io/tls`:

{{< readfile file=../snippets/azkv-pkcs12-cert-external-secret.yaml code="true" lang="yaml" >}}
...
{{< readfile file=../snippets/azkv-pushsecret-secret.yaml code="true" lang="yaml" >}}
> [!NOTE]
>
...
{{< readfile file=../snippets/azkv-pushsecret-key.yaml code="true" lang="yaml" >}}
...
{{< readfile file=../snippets/azkv-pushsecret-certificate.yaml code="true" lang="yaml" >}}
> [!NOTE]
>
