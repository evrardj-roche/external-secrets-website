...
![SecretStore](/diagrams-high-level-ns-detail.png)
...
For a full list of supported fields see [spec](reference-docs/spec.md) or dig into our [guides](../../guides/introduction.md).

{{< readfile file=../../snippets/full-secret-store.yaml code="true" lang="yaml" >}}
