...
![Resource Mapping](/diagrams-resource-mapping.png)

### SecretStore

The idea behind the [SecretStore](../api/core-resources/secretstore.md) resource is to separate concerns of
...
### ExternalSecret
An [ExternalSecret](../api/core-resources/externalsecret.md) declares what data to fetch. It has a reference to a
...
The [ClusterSecretStore](../api/core-resources/clustersecretstore.md) is a global, cluster-wide SecretStore that can be
