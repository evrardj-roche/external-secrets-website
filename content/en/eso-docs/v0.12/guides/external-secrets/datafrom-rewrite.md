+++
title = "Rewriting Keys"
linkTitle = "Rewriting Keys"
weight = 460
+++
...
You can also use [helper functions](advanced-templating/templating.md#helper-functions) in the template.
...
{{< readfile file=../../snippets/datafrom-rewrite-remove-path.yaml code="true" lang="yaml" >}}
...
The following ExternalSecret:
{{< readfile file=../../snippets/datafrom-rewrite-conflict.yaml code="true" lang="yaml" >}}
...
The following ExternalSecret:
{{< readfile file=../../snippets/datafrom-rewrite-invalid-characters.yaml code="true" lang="yaml" >}}
...
The following ExternalSecret:
{{< readfile file=../../snippets/datafrom-rewrite-merge-empty.yaml code="true" lang="yaml" >}}
...
{{< readfile file=../../snippets/datafrom-rewrite-transform.yaml code="true" lang="yaml" >}}
